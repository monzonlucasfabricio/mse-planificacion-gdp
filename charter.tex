...
\begin{itemize}
  \item \textbf{\'{E}pica 1 - Operación segura y control base}
    \begin{itemize}
      \item \textbf{HU1}
      \begin{itemize}
        \item La máquina debe pasar de estado de reposo a estado operativo con botón \textit{START} en menos de 3 s.
        \item La máquina debe detener motores de lanzamiento y alimentación con botón \textit{STOP} en menos de 2 s.
        \item Debe ser posible ejecutar las acciones de inicio y detención tanto desde controles físicos como desde comando remoto.
      \end{itemize}
      \item \textbf{HU2}
      \begin{itemize}
        ...
        \item El sistema debe registrar por interfaz de diagnóstico el motivo de falla o evento equivalente para análisis posterior.
      \end{itemize}
      \item \textbf{HU3}
      \begin{itemize}
        \item El cambio de modo debe poder realizarse con botón \textit{MODE} o comando remoto.
  ...
  \item \textbf{\'{E}pica 2 - Lanzamiento reproducible}
    \begin{itemize}
      ...
      \item \textbf{HU5}
      \begin{itemize}
        \item El sistema debe verificar presencia de pelota en alimentador antes de cada envío.
      ...
      \item \textbf{HU7}
      \begin{itemize}
        \item Los ejes de altitud, azimuth y alimentador deben ejecutar rutina de homing al encendido o al iniciar calibración.
        \item El sistema debe marcar estado calibrado solo cuando se detecten correctamente los sensores de referencia.
        \item Luego de calibrar, al menos 10 ciclos de posicionamiento consecutivos deben ejecutarse sin pérdida de referencia.
      \end{itemize}
    \end{itemize}
  \item \textbf{\'{E}pica 3 - App móvil multiplataforma para validación}
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item La app debe permitir al menos los comandos \textit{START} y \textit{STOP}.
      ...
      \begin{itemize}
        ...
        \item Los parámetros enviados desde app deben quedar reflejados en el programa activo antes de iniciar.
        \item Al menos un entrenamiento completo debe poder ejecutarse usando solo parámetros configurados desde app.
      \end{itemize}
      \item \textbf{HU10}
      \begin{itemize}
        \item La app debe mostrar estado de conexión (conectado/desconectado).
        \item La app debe mostrar modo o estado operativo actual de la máquina.
        \item La app debe mostrar confirmación de recepción para cada comando crítico enviado.
      \end{itemize}
      \item \textbf{HU11}
      \begin{itemize}
  ...
  \item \textbf{\'{E}pica 4 - Pruebas y validación integral}
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item Deben medirse como mínimo repetibilidad de dirección de disparo, continuidad del alimentador y estabilidad operativa.
      \end{itemize}
      \item \textbf{HU13}
      \begin{itemize}
      ...
      \item \textbf{HU14}
      \begin{itemize}
        \item Debe verificarse operación de la app en al menos dos plataformas móviles.
...
HU14 & Validar app en al menos dos plataformas móviles y documentar incidencias & 8 h & Media \\ \hline

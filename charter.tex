...
\begin{itemize}
  ...
  \item \textbf{\'{E}pica 3 - App movil multiplataforma para validacion}
    \begin{itemize}
      ...
      \item \textbf{HU10} (\textit{Prioridad: Media, SP: 3}): Como usuario, quiero visualizar estado mínimo del sistema (conexión, modo y ejecucion) para confirmar que los comandos fueron aplicados.
      \item \textbf{HU11} (\textit{Prioridad: Baja, SP: 2  }): Como usuario, quiero guardar una configuración básica en la app para reutilizarla en la siguiente sesión.
    \end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\'{E}pica 2 - Lanzamiento reproducible}
    \begin{itemize}
      ...
      \item \textbf{HU7}
      \begin{itemize}
        \item Los ejes de altitud, azimuth y alimentador deben ejecutar la rutina de homing al encendido o al iniciar la calibración.
  ...
  \item \textbf{\'{E}pica 3 - App móvil multiplataforma para validación}
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item La app debe permitir tener la mismas funcionalidad de START y STOP que tienen los botones físicos.
  ...
  \item \textbf{\'{E}pica 4 - Pruebas y validación integral}
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item Deben medirse al menos: repetitibilidad en el disparo, continuidad del alimentador y estabilidad del sistema durante un período de tiempo determinado.
      \end{itemize}
      \item \textbf{HU13}
      \begin{itemize}
...
\rowcolor[HTML]{C0C0C0}
Historia de usuario & Tarea técnica & Estimación & Prioridad \\ \hline
HU8 & Implementar base de app multiplataforma (estructura, navegación mínima y permisos Bluetooth) & 8 h & Alta \\ \hline
HU8 & Implementar conexión Bluetooth app-máquina con manejo de reconexión y desconexión segura & 8 h & Alta \\ \hline
HU9 & Desarrollar interfaz de configuración de parámetros (dirección, pausa, potencia) en app & 8 h & Alta \\ \hline
HU9 & Implementar envío y confirmación de parámetros desde app al firmware & 8 h & Alta \\ \hline
HU10 & Implementar visualización en app de estado mínimo (conexión, modo y ejecución) & 8 h & Media \\ \hline
HU10 & Implementar confirmación de comandos críticos (ACK/NACK) para acciones de control & 6 h & Alta \\ \hline
HU11 & Implementar guardado local de un perfil básico de entrenamiento en app & 6 h & Baja \\ \hline
